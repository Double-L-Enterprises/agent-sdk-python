...
class StreamingTransportMixin:
    ...
    async def do_turn_streaming(self, on_token: StreamCallback) -> dict[str, Any]:
                                ...
                                for tool_call_delta in delta["tool_calls"]:
                                    ...
                                    if "function" in tool_call_delta:
                                        ...
                                        if "name" in func_delta:
                                            existing_call["function"]["name"] = func_delta["name"]
                                        if "arguments" in func_delta:
                                            existing_call["function"]["arguments"] += func_delta["arguments"]
        ...
        if hasattr(self, '_messages'):
            assistant_msg: dict[str, Any] = {"role": "assistant", "content": accumulated_text}
            if final_tool_calls:
